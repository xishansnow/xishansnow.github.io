...
![image-20210414204934334](C:\Users\89877\AppData\Roaming\Typora\typora-user-images\image-20210414204934334.png)
...
其中，当上下文 POI 为 $l_j$ 时，$β^{l_j}_{Checkin}$ 是训练元组 $(t_{center}，t_{context})$ 的增强因子。这是一种外在的增强方法。
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414210828_be.webp)
...
$$
A=-\log _{2}\left(1-\frac{P_{t j}}{1+\sum_{k=1}^{|M|} P_{t k}^{h}}\right)
$$
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414211340_95.webp)
...
$$
\operatorname{SIM}_{W P}\left(t_{1}, t_{2}\right)=\frac{2 N_{3}}{N_{1}+N_{2}+2 N_{3}}
$$
...
$$
\operatorname{SIM}_{\text {Lin }}\left(t_{1}, t_{2}\right)=\frac{2 I C\left(t_{l c s}\right)}{I C\left(t_{1}\right)+I C\left(t_{2}\right)}
$$
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212147_7a.webp)
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212340_fa.webp)
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212516_bf.webp)
...
![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212706_4a.webp)

![](https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212732_a0.webp)
...
<img src="https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212848_a6.webp" style="zoom:67%;" />

<img src="https://gitee.com/XiShanSnow/imagebed/raw/master/images/articles/spatialPresent_20210414212911_c9.webp" style="zoom: 67%;" />
...
[^1]: 相似性和关联性是相关的概念，实际上相似性是关联性的一个子属性，而不是相反。举一个直观的例子，格里菲斯天文台与格里菲斯·詹金斯·格里菲斯是通过捐赠者关系联系在一起的，但天文台和这个人并不相似。许多技术，特别是那些基于语言方面(包括word2vec[19])而不是形式语义的技术，不能有效地区分相似性和关联性。因此，我们在这里一起接近他们。然而，我们的三个评估模式中的两个将明确地侧重于(人类)相似性评估。
